...
DROP VIEW IF EXISTS heatmap_daily_aggregates CASCADE;
DROP VIEW IF EXISTS heatmap_hourly_aggregates CASCADE;
DROP FUNCTION IF EXISTS get_heatmap_stats CASCADE;
